...
class ImportListsTests(TestCase):
    ...
    def test_import_lists_assigns_order_and_publication(self):
        ...
        orders = list(models.List.objects.order_by('order').values_list('order', flat=True))
...
class ImportListMembershipsTests(TestCase):
    ...
    def setUp(self):
        ...
        models.Game.objects.create(name='Game 1', rank=1, igdb_id=1, year_of_release=1990)
        models.Game.objects.create(name='Game 2', rank=2, igdb_id=2, year_of_release=1991)
...
class ImportDevelopersTests(TestCase):
    ...
    def test_import_developers_creates_aliases(self):
        data = (
            "Foo Studio\tFoo Studio\tFoo Devs\r\n"
